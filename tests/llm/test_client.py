...
class TestClientNonStreaming(unittest.TestCase):
    ...
    def test_sync_error_raises_api_error(self):
        ...
        from python_agent_harness.llm.client import ApiError
...
class TestClientRetry(unittest.TestCase):
    ...
    def test_retry_budget_exhausted_raises(self):
        ...
        from python_agent_harness.llm.client import RetryableApiError
...
class TestClientHelpers(unittest.TestCase):
    ...
    def test_retry_delay_honors_retry_after(self):
        from python_agent_harness.llm.client import _retry_delay
    ...
    def test_llm_log_path_uses_env_dir(self):
        ...
        from python_agent_harness.llm.client import _llm_log_path
    ...
    def test_resolve_ca_bundle_prefers_env(self):
        ...
        from python_agent_harness.llm.client import _resolve_ca_bundle
    ...
    def test_resolve_ca_bundle_falls_back_to_true(self):
        ...
        with (
            ...
            mock.patch("python_agent_harness.llm.client.os.path.isfile", return_value=False),
        ):
...
class TestClientLogging(unittest.TestCase):
    ...
    def _logged(self, tmpdir, payload, resp, usage):
        from python_agent_harness.llm.client import _log_llm_interaction
...
class TestClientAbort(unittest.TestCase):
    ...
    def test_abort_swaps_client_and_closes_old(self):
        ...
        old = c._http
        with (
            mock.patch("python_agent_harness.llm.client._abort_inflight_sockets") as ab,
    ...
    def test_abort_tolerates_socket_wake_failure(self):
        ...
        old = c._http
        with mock.patch(
            "python_agent_harness.llm.client._abort_inflight_sockets",
    ...
    def test_abort_tolerates_close_failure(self):
        ...
        old = c._http
        with (
            mock.patch("python_agent_harness.llm.client._abort_inflight_sockets"),
...
class TestAbortInflightSockets(unittest.TestCase):
    ...
    def test_shuts_down_and_closes_live_socket(self):
        ...
        from python_agent_harness.llm.client import _abort_inflight_sockets
...
class TestAuthRefreshOn401(unittest.TestCase):
    ...
    def test_401_with_refreshed_key_retries_and_succeeds(self):
        ...
        from python_agent_harness.llm.client import AuthExpiredError
    ...
    def test_401_with_unchanged_key_fails_immediately(self):
        ...
        from python_agent_harness.llm.client import ApiError, AuthExpiredError
...
class TestAuthRefreshOnConfigurableStatusCodes(unittest.TestCase):
    ...
    def test_custom_status_code_triggers_auth_refresh(self):
        ...
        with (
            mock.patch("python_agent_harness.session.config.AUTH_REFRESH_STATUS_CODES", [401, 419]),
            mock.patch.object(c, "_stream_response", side_effect=fake_stream),
            mock.patch.object(c, "_refresh_api_key", return_value=True),
        ):
            msg, _ = c.chat([Message(role="user", content="hi")])
    ...
    def test_503_not_in_auth_refresh_still_retryable(self):
        ...
        from python_agent_harness.llm.client import ApiError, RetryableApiError
...
class TestImageInputModelResolution(unittest.TestCase):
    ...
    def _img_msg(self):
        from python_agent_harness.core.models import ImagePart
