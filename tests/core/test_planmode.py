...
from python_agent_harness.core.planmode import PlanMode, _plan_temp_dir
...
class TestPlanTempDir(unittest.TestCase):
    ...
    def test_falls_back_to_plain_tmp(self):
        ...
        try:
            with mock.patch(
                "python_agent_harness.core.planmode.tempfile.gettempdir",
                return_value="",
            ):
    ...
    def test_cleanup_tolerates_oserror(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            path = pm.plan_file
            with mock.patch(
                "python_agent_harness.core.planmode.os.remove",
