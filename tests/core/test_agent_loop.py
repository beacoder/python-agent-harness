...
from python_agent_harness.core.planmode import PlanMode
...
from tests.support.agent_test_utils import (  # noqa: E402,F401
    FakeClient,
    ParallelToolSession,
    RealParallelSession,
    RecordingSession,
...
class TestAgentLoop(unittest.TestCase):
    ...
    def test_compact_on_high_context(self):
        ...
        with mock.patch("python_agent_harness.session.config.MAX_NUDGES", 0):
            calls = {"n": 0}
    ...
    def test_non_streaming_http_tool_round_end_to_end(self):
        ...
        from tests.support import fake_openai_server
        from tests.support.fake_openai_server import serve
