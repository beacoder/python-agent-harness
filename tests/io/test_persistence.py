...
from python_agent_harness.io.persistence import (
    SessionPersistence,
    escape_role_headers,
    sanitize_title,
    split_role_header,
...
class TestSession(unittest.TestCase):
    ...
    def test_apply_title_oserror_keeps_original_file(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            try:
                ...
                with mock.patch(
                    "python_agent_harness.io.persistence.os.replace",
    ...
    def test_parse_metadata_without_block(self):
        self.assertEqual(SessionPersistence.parse_metadata("just a conversation"), {})
    ...
    def test_latest_session_missing_dir(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            try:
                self.assertIsNone(SessionPersistence.latest_session())
            finally:
                config.SESSION_DIR = old_dir
    ...
    def test_list_sessions_missing_dir(self):
        ...
        with tempfile.TemporaryDirectory() as d:
            ...
            try:
                self.assertEqual(SessionPersistence.list_sessions(), [])
            finally:
                config.SESSION_DIR = old_dir
