...
from python_agent_harness.io.attachments import parse_at_references
from python_agent_harness.session.config import DEFAULT_LLM, load_llm_config
...
class TestImageTokenEstimation(unittest.TestCase):
    def test_image_parts_counted_in_payload(self):
        from python_agent_harness.core import token_estimator as te
...
class TestParseAtReferences(unittest.TestCase):
    ...
    def test_large_image_error(self):
        from python_agent_harness.io import attachments as att_mod
...
class TestClientImageStripping(unittest.TestCase):
    ...
    def test_strip_image_parts_from_message(self):
        from python_agent_harness.llm.client import _strip_image_parts
...
class TestRestoreReattach(unittest.TestCase):
    ...
    def test_reattach_url_image(self):
        from python_agent_harness.io.attachments import reattach_images
