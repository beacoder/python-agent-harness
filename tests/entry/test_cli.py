...
class TestMakeSessionPromptDefaults(unittest.TestCase):
    ...
    def test_custom_commands_not_cli_subcommands(self):
        ...
        """
        from python_agent_harness.session.commands import (
            find_command,
...
class TestCommandToolAvailability(unittest.TestCase):
    ...
    def test_hide_planexit_noop_without_registry(self):
        ...
        from python_agent_harness.session.commands import hide_planexit
...
class TestCliEntryPoints(unittest.TestCase):
    ...
    def test_run_no_stream_flag_forwarded(self):
        ...
        with (
            mock.patch("python_agent_harness.entry.cli.make_session_with_mcp") as ms,
    ...
    def test_module_main_calls_sys_exit(self):
        """`python -m python_agent_harness.entry.cli` must call sys.exit(main()).
...
def _load(path, project_dir=None, with_context=False, tool_instructions=None, excluded_tools=()):
    ...
    from python_agent_harness.session.session import find_context_dir, find_skill_dir
