...
class MCPManager:
    ...
    def _call(self, coro: Coroutine[Any, Any, Any], timeout: float | None = None) -> Any:
        return self._ensure_loop().run(coro, timeout=timeout)
    ...
    def _connect_one(self, name: str) -> str | None:
        ...
        try:
            ...
            return f"MCP server {name!r} failed to connect: {e}"
    ...
    def call_tool(
        ...
        return self._call(client.call_tool(tool, arguments), timeout=effective_timeout)
