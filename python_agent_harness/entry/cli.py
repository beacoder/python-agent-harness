...
def make_session(
    ...
    from ..session.session import find_skill_dir
    ...
    session = Session(
        ...
        supports_image_input=settings["supports_image_input"],
        ...
        subagent_supports_image_input=subagent_settings["supports_image_input"],
        registry=registry,
        context_path=paths.get("context_path"),
